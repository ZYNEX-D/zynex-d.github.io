                    ...
                    <div class="text-gray-600 dark:text-gray-300 lg:pr-4">
                        <ul class="space-y-6 text-base font-medium tracking-wide lg:flex lg:space-y-0 lg:text-sm">
                            ...
                            <li data-aos="fade-left" data-aos-duration="1000" data-aos-delay="100">
                                <a href="services.php" class="block transition hover:text-primary dark:hover:text-primaryLight md:px-4">
                                    <span>Services</span>
                                </a>
                            </li>
                            <li data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                                <a href="websites.php" class="block transition hover:text-primary dark:hover:text-primaryLight md:px-4">
                                    <span>Websites</span>
                                </a>
                            </li>
                            ...
                            <li data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
                                <a href="portfolio.php" class="block transition hover:text-primary dark:hover:text-primaryLight md:px-4">
                                    <span>Portfolio</span>
                                </a>
                            </li>
                            <li data-aos="fade-left" data-aos-duration="1000" data-aos-delay="400">
                                <a href="about.php" class="block transition hover:text-primary dark:hover:text-primaryLight md:px-4">
                                    <span>About</span>
                                </a>
                            </li>
                        </ul>
